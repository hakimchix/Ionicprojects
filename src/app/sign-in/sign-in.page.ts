...
export class SignInPage {
  ...
  constructor(
    ...
    private authService: FirebaseAuthService,public alertController: AlertController
  ) {
  ...
  async resetEmail(){    
    ...
    header: 'Confirm!',
    message: '<strong>Reset account</strong>',
    inputs: [
      {
        name: 'Remail',
        type: 'email',
    ...
    buttons: [
      {
        ...
        cssClass: 'danger',
        handler: (data) => {
          this.authService.resetPassword( data.Remail)
        }
      }
    ]
  });
